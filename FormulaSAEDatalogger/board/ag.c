...
//                                    PORT_PCR_ODE(ENABLE));
//
//    PORTE->PCR[INT1_PIN_NUM] = (PORT_PCR_MUX(ALT_1_GPIO) |
//                                PORT_PCR_ODE(ENABLE));
//
//    PORTE->PCR[INT2_PIN_NUM] = (PORT_PCR_MUX(ALT_1_GPIO) |
//                                PORT_PCR_ODE(ENABLE));
//
...
//
//    /* Enable PORTE interrupts (for the accelerator's INT1 and INT2), with
//     * priority change for use with FreeRTOS */
